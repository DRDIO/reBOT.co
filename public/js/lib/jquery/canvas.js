...
(function($) {
	...
	$.fn.canvasWidth = function() {
		return this[0].cnvs.w;
	}
	
	$.fn.canvasHeight = function() {
		return this[0].cnvs.h;
	}
	
	$.fn.canvasContext = function() {
		return this[0].cnvs.c;
	}
	...
	$.fn.drawImage = function(image, coord) {
		$( this).each( function() {
			this.cnvs.drawImage(image, coord); 
			return this;
		});
		return this;	
	}
	...
	function canvasObject( $canvas, width, height) {
		...
		cnvs.drawImage = function(image, coord) { 
			this.c.drawImage(
				image, coord[ 0], coord[ 1]
			);
		}
